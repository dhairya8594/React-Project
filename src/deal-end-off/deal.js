...
import './deal.css';
import Img from '../new-arr-sep-off/def.png';
  ...
  return (
    <div className='deal'>
            <div className='bar-d'>
               {/* <div className="bar"> */}
                <div className="divv">
                <h2 className="img"  >DEAL OF THE DAY</h2>
          ...
          <div className='sidebar3'>
                ...
                <h3 className='ttx'>Orci attahche</h3>
                <h4 className='ttx'>Get Pricing</h4>
              <img src={Img} className='def1'/>
              
           </div>  
           <div class="card-list4">
        <a href="#" class="card-item4">
            <img src={Card1} alt="Card Image"/>
            <div className='text2'>
                <h5>Quis ullamcorper</h5>
                <div className='ggg'>
                <p className='tt'>Available:200  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sold:10</p>
            ...
            <div className='b-get-p'>
                ...
                <button className='g-p1'>Get Price</button>
            </div>
    ...
    {/* ----offer----- */}
     <div className='offer1'>
         <div div className='bar-f'>
               {/* <div className="bar"> */}
                <div className="divv">
                <h2 className="img"  >Offers Ending Soon</h2>
                {/* <img className="fire" alt="Fire" src={Fire} /> */}
                </div>
                <div className="divv-2">
                {/* <h3 className="img" >ENDING IN</h3> */}
         ...
         <div className="sep">
             ...
             <h3 className="img-s" >TOP RATED</h3>
             </div>
             <div className="div-s">
